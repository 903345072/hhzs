	...
	export default{
		...
		methods:{
			...
			doorder(){
				...
				var data = {"type":this.game_type,"num":this.check_game.length,"checkGame":JSON.stringify(this.check_game),"bei":this.bei,"mode":this.mode,"chuan":JSON.stringify(chuan_arr),"num_arr":JSON.stringify(this.num_arr),"plan_desc":this.plan_desc,"is_open":this.is_open}
